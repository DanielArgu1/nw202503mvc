<section class="depth-2 px-4 py-4" 
  style="display: flex; justify-content: space-between; align-items: center; background-color: #f5f5f5; padding: 1rem 2rem; border-bottom: 2px solid #8a4242;">
...
<section style="text-align: center; margin: 2rem 0 1.5rem 0;">
  <form action="index.php" method="get" style="display: inline-flex; gap: 0.5rem; align-items: center;">
    ...
    <button 
      type="submit" 
      style="background-color: rgb(215, 67, 235); color: rgb(236, 236, 236); border: none; padding: 0.5rem 1rem; font-size: 1rem; border-radius: 6px; cursor: pointer;"
    >
      Buscar
    </button>
  </form>
...
<div style="margin-top: 1rem; text-align: center;">
  ...
  <form action="index.php?page=index" method="post" style="margin-top: 0.75rem;">
    ...
    <button type="submit" name="addToCart" style="
      background-color: rgb(215, 67, 235);
      color: white;
      border: none;
      padding: 0.5rem 1rem;
      font-size: 1rem;
